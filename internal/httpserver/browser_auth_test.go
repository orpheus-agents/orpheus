	...
	for _, mode := range []string{"api_only", "anonymous", "saml"} {
		t.Run(mode, func(t *testing.T) {
			...
			for _, tc := range []struct {
				...
				{name: "bearer limits", method: "GET", path: "/api/v1/accounts/limits", auth: "Bearer key", hasAuth: true, want: 200},
				...
				{name: "cookie limits", method: "GET", path: "/api/v1/accounts/limits", cookie: token, want: map[string]int{"api_only": 401, "saml": 200, "anonymous": 200}[mode]},
